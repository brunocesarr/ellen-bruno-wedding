  ...
  return (
    <>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.92 }}
        className="fixed bottom-6 left-6 z-50 flex h-11 w-11 items-center justify-center p-2 rounded-full border border-white/40 bg-white/30 text-stone-700 shadow-lg backdrop-blur-md transition-colors hover:bg-white/50"
      >
        <motion.span
