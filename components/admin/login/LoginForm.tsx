  ...
  return (
    ...
    >
      <header className="mb-8 text-center">
        ...
        <p className="mt-3 text-sm text-stone-500">Acesso restrito ao casal</p>
      </header>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
        <label className="block">
          ...
          {errors.email && (
            <span id="email-error" className="mt-1 block text-xs text-rose-600">
        ...
        <label className="block">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`
              w-full rounded-lg border bg-white py-2.5 pl-10 pr-10 text-sm
              outline-none transition
              ${
                errors.password
                  ? 'border-rose-400 focus:border-rose-500'
        ...
        <button
          ...
          bg-amber-700 py-3 text-sm font-medium text-white
